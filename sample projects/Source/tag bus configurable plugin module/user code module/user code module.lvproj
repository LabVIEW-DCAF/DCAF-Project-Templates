...
<Project Type="Project" LVVersion="13008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="user code tests.lvlib" Type="Library" URL="../testing/user code tests.lvlib"/>
		<Item Name="user tag bus module configuration.lvclass" Type="LVClass" URL="../module/configuration/user tag bus module configuration.lvclass"/>
		<Item Name="user tag bus module editor node.lvclass" Type="LVClass" URL="../editor node/user tag bus module editor node.lvclass"/>
		<Item Name="user tag bus module.lvclass" Type="LVClass" URL="../module/execution/user tag bus module.lvclass"/>
