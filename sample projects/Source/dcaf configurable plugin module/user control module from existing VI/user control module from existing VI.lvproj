...
<Project Type="Project" LVVersion="13008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="channel specification from user VI path.vi" Type="VI" URL="../scripting/channel specification from user VI path.vi"/>
			...
			<Item Name="detect datatype.vi" Type="VI" URL="../scripting/detect datatype.vi"/>
			<Item Name="expand bundle.vi" Type="VI" URL="../scripting/expand bundle.vi"/>
			<Item Name="expand unbundle.vi" Type="VI" URL="../scripting/expand unbundle.vi"/>
			<Item Name="FixedChannelTBModuleDecideFeatures.lvclass" Type="LVClass" URL="../scripting/FixedChannelTBModuleDecideFeatures.lvclass"/>
			...
			<Item Name="get results and parameters refs.vi" Type="VI" URL="../scripting/get results and parameters refs.vi"/>
			<Item Name="get user path.vi" Type="VI" URL="../scripting/get user path.vi"/>
			...
			<Item Name="map (un)bundle to subVI.vi" Type="VI" URL="../scripting/map (un)bundle to subVI.vi"/>
			<Item Name="MetaDataObj.lvclass" Type="LVClass" URL="/&lt;resource&gt;/dialog/NewProjectWizard/MetaDataObj/MetaDataObj.lvclass"/>
			<Item Name="replace stump vi with user vi.vi" Type="VI" URL="../scripting/replace stump vi with user vi.vi"/>
			<Item Name="script user process vi.vi" Type="VI" URL="../scripting/script user process vi.vi"/>
			<Item Name="set user path.vi" Type="VI" URL="../scripting/set user path.vi"/>
